...
app.post('/Signup',async(req,res) =>{
    ...
    if (allowedDomains.includes(domain)) {
      // Proceed with signup
      // Redirect user to further signup steps or process registration
      ...
      // Notify user that only organization emails are allowed
      return res.status(400).json({ error: 'Only organization emails are allowed for signup' });
    }
